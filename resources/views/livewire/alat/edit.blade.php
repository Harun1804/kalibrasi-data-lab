                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('namaAlat') is-invalid @enderror" id="namaAlat" placeholder="Enter Nama Alat" required wire:model="namaAlat" value="{{ old('namaAlat',$namaAlat) }}">
                                @error('namaAlat')
